		...
		try( InputStream inputStream = new FileInputStream(excelPath);
			...
			.forEach(s->{
				if(s.getCell(4)!=null){
					...
					provider.setPfinStartDate(s.getCell(5)!=null?df.format(s.getCell(5).getDateCellValue()):null);
					provider.setPfinEndDate(s.getCell(6)!=null?df.format(s.getCell(6).getDateCellValue()):null);
				...
				if(s.getCell(4)==null && s.getCell(5).getCellType()!=XSSFCell.CELL_TYPE_STRING){
					...
					providerNetworkInfo.setNetworkEffDate(s.getCell(5)!=null?df.format(s.getCell(5).getDateCellValue()):null);
					providerNetworkInfo.setNetworkEndDate(s.getCell(6)!=null?df.format(s.getCell(6).getDateCellValue()):null);
